...
// import 'package:llama_library/babylon/src/bindings.dart';
// import "package:path/path.dart" as path;

// class TextToSpeechLlamaLibrary {
//   final Directory directoryTemp;
//   TextToSpeechLlamaLibrary({
...
//         _lib = BabylonIo(DynamicLibrary.open('tts_llama_library.dll'));
//       } else if (Platform.isLinux || Platform.isAndroid) {
//         _lib = BabylonIo(DynamicLibrary.open('/home/galaxeus/Documents/github/general-developer/llama_library/package/llama_library_flutter/linux/libtts_llama_library.so'));
//       } else if (Platform.isMacOS || Platform.isIOS) {
//         _lib = BabylonIo(DynamicLibrary.open('libtts_llama_library.dylib'));
//       } else {
...
//       return File(
//         "/home/galaxeus/Documents/github/general-developer/llama_library/package/llama_library/models/deep_phonemizer.onnx",
//       );
//     });

//     final File vitsModel = await Future(() async {
//       return File(
//         "/home/galaxeus/Documents/github/general-developer/llama_library/package/llama_library/models/amy.onnx",
//       );
//     });
...
//   final TextToSpeechLlamaLibrary textToSpeechLlamaLibrary = TextToSpeechLlamaLibrary(
//     directoryTemp: Directory(path.join(Directory.current.path, "temp")),
//   );

//   await textToSpeechLlamaLibrary.init();

//   final String text = "Hello World";
//   final result = textToSpeechLlamaLibrary.createSpeech(text: text);
//   print(result);
