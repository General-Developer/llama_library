...
class _SpeechToTextPageState extends State<WhisperSpeechToTextPage> with GeneralLibFlutterStatefulWidget {
  ...
  bool loadWhisperModel({
    ...
    final bool isLoadedModel = LlamaAppClientFlutter.whisperLibrary.loadWhisperModel(
                      ...
                      menuBuilder: (context) {
                        return [
                          MenuContainerGeneralFrameworkWidget.lisTile(
                            ...
                            title: "Support",
                            trailing: Icon(
                              (LlamaAppClientFlutter.whisperLibrary.isDeviceSupport() == true) ? Icons.verified : Icons.close,
                            ),
                          ),
                          MenuContainerGeneralFrameworkWidget.lisTile(
                            context: context,
                            ...
                            onTap: () {
                              handleFunction(
                                onFunction: (context, statefulWidget) async {
                                  ...
                                  try {
                                    transcribeFromExampleJFKToJson = await LlamaAppClientFlutter.whisperLibrary.transcribeToJson(
                            ...
                            onTap: () {
                              handleFunction(
                                onFunction: (context, statefulWidget) async {
                                  ...
                                  DateTime dateTime = DateTime.now();
                                  try {
                                    transcribeFromRecordToJson = await LlamaAppClientFlutter.whisperLibrary.transcribeToJson(
  ...
  GeneralAudioRecorder getGeneralAudioRecorder() {
    ...
    generalAudioRecorder = LlamaAppClientFlutter.generalFlutter.system_audio.generalAudio.createRecordOrGetRecord(
